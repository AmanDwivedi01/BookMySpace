...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">BookMySpace</a>
    </div>
			...
			<div class="panel-body">
				...
				<div class="col-md-3">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">1.BOOK YOUR SPACE
								</h3>
							</div>
							<div class="panel-body">
							SCHEDULE OF EVENTS
					...
					<div class="col-md-3">
						<div class="panel panel-success">
							<div class="panel-heading">
								<h3 class="panel-title">3.PARTICIPANT INFO
				...
				<div class="container-fluid">
					<form class="form-horizontal" role="form" id="form-pass">
					  ...
					  <div class="form-group">
					    ...
					    <input type="text" class="form-control" id="address" placeholder="Enter E-Mail" required="" autocomplete="off">
					  </div>
					<br />
					<?php 
					  ...
					  <div class="panel panel-primary">
					  	...
					  	<div class="panel-body">
					  		<div class="container-fluid">
								  ...
								  <div class="form-group">
								    <label for="">University Rollno: (<?= $count; ?>):</label>
								    <input type="number" class="form-control" id="age<?php echo $i; ?>"
								    placeholder="Enter Rollno" required autocomplete="off">
								  </div>
								  <div class="form-group">
